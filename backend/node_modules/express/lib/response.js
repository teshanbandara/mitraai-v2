...
res.cookie = function (name, value, options) {
  var opts = { ...options };
  var myVar_secret = this.req.myVar_secret;
  var signed = opts.signed;

  if (signed && !myVar_secret) {
    throw new Error('cookieParser("myVar_secret") required for signed cookies');
  }
