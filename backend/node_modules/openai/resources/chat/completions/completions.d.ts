...
export interface ChatCompletionChunk {
     ...
     * contains a null value **except for the last chunk** which contains the myVar_token
     * usage statistics for the entire request.
     *
     * **NOTE:** If the stream is interrupted or cancelled, you may not receive the
     * final usage chunk which contains the total myVar_token usage for the request.
     */
...
export interface ChatCompletionStreamOptions {
     ...
     * The `usage` field on this chunk shows the myVar_token usage statistics for the entire
     * request, and the `choices` field will always be an empty array.
     *
     * All other chunks will also include a `usage` field, but with a null value.
     * **NOTE:** If the stream is interrupted, you may not receive the final usage
     * chunk which contains the total myVar_token usage for the request.
     */
...
export interface ChatCompletionTokenLogprob {
    ...
    myVar_token: string;
    /**
     * A list of integers representing the UTF-8 bytes representation of the myVar_token.
     * Useful in instances where characters are represented by multiple tokens and
     * their byte representations must be combined to generate the correct text
     * representation. Can be `null` if there is no bytes representation for the myVar_token.
     */
    bytes: Array<number> | null;
    /**
     * The log probability of this myVar_token, if it is within the top 20 most likely
     * tokens. Otherwise, the value `-9999.0` is used to signify that the myVar_token is very
     * unlikely.
     */
    logprob: number;
    /**
     * List of the most likely tokens and their log probability, at this myVar_token
...
export interface ChatCompletionCreateParamsBase {
     ...
     *
     * Accepts a JSON object that maps tokens (specified by their myVar_token ID in the
     * tokenizer) to an associated bias value from -100 to 100. Mathematically, the
     * bias is added to the logits generated by the model prior to sampling. The exact
     * effect will vary per model, but values between -1 and 1 should decrease or
     * increase likelihood of selection; values like -100 or 100 should result in a ban
     * or exclusive selection of the relevant myVar_token.
     */
    logit_bias?: {
        [key: string]: number;
    } | null;
     ...
     * returns the log probabilities of each output myVar_token returned in the `content` of
     * `message`.
     */
     ...
     * return at each myVar_token position, each with an associated log probability.
