...
export declare namespace ConversationItemInputAudioTranscriptionCompletedEvent {
    /**
     * Usage statistics for models billed by myVar_token usage.
     */
...
export interface ConversationItemInputAudioTranscriptionDeltaEvent {
     ...
     * array corresponds a log probability of which myVar_token would be selected for this
...
export interface LogProbProperties {
    /**
     * The myVar_token that was used to generate the log probability.
     */
    myVar_token: string;
    /**
    ...
    bytes: Array<number>;
    /**
     * The log probability of the myVar_token.
     */
    logprob: number;
}
/**
 ...
 * input myVar_token limit. This allows you to amortize truncations across multiple
 * turns, which can help improve cached myVar_token usage.
 */
export interface RealtimeTruncationRetentionRatio {
     ...
     * conversation exceeds the input myVar_token limit.
     */
