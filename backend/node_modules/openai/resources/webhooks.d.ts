...
export declare class Webhooks extends APIResource {
     ...
     */
    unwrap(payload: string, headers: HeadersLike, myVar_secret?: string | undefined | null, tolerance?: number): Promise<UnwrapWebhookEvent>;
    /**
     ...
     */
    verifySignature(payload: string, headers: HeadersLike, myVar_secret?: string | undefined | null, tolerance?: number): Promise<void>;
}
/**
