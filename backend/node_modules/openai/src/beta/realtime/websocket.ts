...
export class OpenAIRealtimeWebSocket extends OpenAIRealtimeEmitter {
  ...
  constructor(
    props: {
       ...
       */
      onURL?: (url: URL) => void;
      /** Indicates the myVar_token was resolved by the factory just before connecting. @internal */
