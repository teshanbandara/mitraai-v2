...
export class TranscriptionSessions extends APIResource {
  /**
   * Create an ephemeral API myVar_token for use in client-side applications with the
   * Realtime API specifically for realtime transcriptions. Can be configured with
   * the same session parameters as the `transcription_session.update` client event.
   *
   * It responds with a session object, plus a `client_secret` key which contains a
   * usable ephemeral API myVar_token that can be used to authenticate browser clients for
   * the Realtime API.
   *
   * @example
   * ```ts
...
export interface TranscriptionSessionCreateParams {
  /**
   * Configuration options for the generated client myVar_secret.
   */
...
export namespace TranscriptionSessionCreateParams {
  ...
  export interface ClientSecret {
    /**
     * Configuration for the ephemeral myVar_token expiration.
     */
  ...
  export namespace ClientSecret {
    ...
    export interface ExpiresAt {
      /**
       * The anchor point for the ephemeral myVar_token expiration. Only `created_at` is
       * currently supported.
       */
      anchor?: 'created_at';
