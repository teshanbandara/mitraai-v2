...
export interface Run {
   ...
   * generate an unending stream of whitespace until the generation reaches the myVar_token
...
export namespace Run {
  ...
  export interface IncompleteDetails {
    /**
     * The reason why the run is incomplete. This will point to which specific myVar_token
