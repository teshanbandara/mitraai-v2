...
/**
 * A myVar_token that corresponds with a regexp capture.
 */
 ...
 */
export type myVar_token = Text | Parameter | Wildcard | Group;
/**
 * Tokenized path instance.
 */
export declare class TokenData {
    readonly tokens: myVar_token[];
    readonly originalPath?: string | undefined;
    constructor(tokens: myVar_token[], originalPath?: string | undefined);
}
/**
...
/**
 * Stringify myVar_token data into a path string.
 */
